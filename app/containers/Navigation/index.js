          ...
          <Container>
            <Row>
              <Col md='4' className='text-center d-none d-md-block'>
                ...
                <span>ئۆنلاین بازار</span>
              </Col>
              <Col md='4' className='text-center d-none d-md-block'>
                <i className='fa fa-credit-card' />
                <span>شێوازی پارەدانی ئۆنلاین</span>
              </Col>
              <Col md='4' className='text-center d-none d-md-block'>
                <i className='fa fa-phone' />
                <span>پەیوەندی کردن: ٠٩٣٤ ٥١٧ ٠٧٥١</span>
              </Col>
          ...
          <Row className='align-items-center top-header'>
            ...
            >
              <div className='brand'>
                ...
                <Link to='/'>
                  <h1 className='logo'>لاڤێندەر ستۆر</h1>
                </Link>
              </div>
            </Col>
            <Col
                  ...
                  {authenticated ? (
                    <UncontrolledDropdown nav inNavbar>
                      ...
                      <DropdownMenu right>
                        ...
                        <DropdownItem onClick={signOut}>چوونەدەرەوە</DropdownItem>
                      </DropdownMenu>
                    </UncontrolledDropdown>
                  ) : (
                    <UncontrolledDropdown nav inNavbar>
